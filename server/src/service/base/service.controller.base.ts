...
import { AppoitmentWhereInput } from "../../appoitment/base/AppoitmentWhereInput";
import { Appoitment } from "../../appoitment/base/Appoitment";
...
export class ServiceControllerBase {
  ...
  @common.UseInterceptors(nestMorgan.MorganInterceptor("combined"))
  @common.UseGuards(basicAuthGuard.BasicAuthGuard, nestAccessControl.ACGuard)
  @common.Get("/:id/appoitments")
  @nestAccessControl.UseRoles({
    resource: "Service",
    action: "read",
    possession: "any",
  })
  async findManyAppoitments(
    @common.Param() params: ServiceWhereUniqueInput,
    ...
    const results = await this.service.findAppoitments(params.id, {
      where: query,
      select: {
        active: true,
        address: true,
  ...
  @common.UseInterceptors(nestMorgan.MorganInterceptor("combined"))
  @common.UseGuards(basicAuthGuard.BasicAuthGuard, nestAccessControl.ACGuard)
  @common.Post("/:id/appoitments")
  @nestAccessControl.UseRoles({
    resource: "Service",
    action: "update",
    possession: "any",
  })
  async createAppoitments(
    @common.Param() params: ServiceWhereUniqueInput,
  ...
  @common.UseInterceptors(nestMorgan.MorganInterceptor("combined"))
  @common.UseGuards(basicAuthGuard.BasicAuthGuard, nestAccessControl.ACGuard)
  @common.Patch("/:id/appoitments")
  @nestAccessControl.UseRoles({
    resource: "Service",
    action: "update",
    possession: "any",
  })
  async updateAppoitments(
    @common.Param() params: ServiceWhereUniqueInput,
    @common.Body() body: ServiceWhereUniqueInput[],
    @nestAccessControl.UserRoles() userRoles: string[]
  ): Promise<void> {
  ...
  @common.UseInterceptors(nestMorgan.MorganInterceptor("combined"))
  @common.UseGuards(basicAuthGuard.BasicAuthGuard, nestAccessControl.ACGuard)
  @common.Delete("/:id/appoitments")
  @nestAccessControl.UseRoles({
    resource: "Service",
    action: "update",
    possession: "any",
  })
  async deleteAppoitments(
    @common.Param() params: ServiceWhereUniqueInput,
    @common.Body() body: ServiceWhereUniqueInput[],
    @nestAccessControl.UserRoles() userRoles: string[]
  ): Promise<void> {
